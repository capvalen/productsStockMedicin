...
$sqlNombre=$db->prepare("SELECT p.nombre, d.*, m.descripcion, pro.nombre as proveedor, t.nombre as destino FROM `detalles` d
...
where idTopico= ? and d.activo=1 and idMovimiento in (2,4);");
